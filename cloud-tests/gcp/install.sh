...
ssh -t -o StrictHostKeyChecking=no $IP "wget -nc https://raw.githubusercontent.com/logicalclocks/karamel-chef/karamel_installer/hopsworks-installer.sh && chmod +x hopsworks-installer.sh"
