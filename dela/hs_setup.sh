...
declare -a VALUES=("GITHUB" "BRANCH" "USER_SETTING" "NETWORK_INTERFACE" "CLIENT_TYPE" "REPORT_TRACKER" "SOURCE_CODE" "DELA_VERSION" "HS_VERSION" "DELA1_P" "DELA2_P" "DELA3_P" "DELA4_P" "WEB_P" "WEB_SEC_P" "HOPSSITE_DOMAIN" "HS_WEB1_P" "HS_WEB2_P" "CLUSTER_EMAIL" "CLUSTER_PASSWORD" "CLUSTER_ORG" "CLUSTER_UNIT" "CLUSTER_MANUAL_REGISTER")
